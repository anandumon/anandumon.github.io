...
import "./Home.css";
import ananduprofile from "../assets/img/anandu.png";
import Pdf from "../assets/pdf/anandumon(cv).pdf";
          ...
          <div className="col-sm-5">
            <div className="imgsec">
              <img
                src={ananduprofile}
                data-aos="flip-right"
                alt="Anandumon U N | Portfolio"
                className="img-fluid"
              />
              <div className="socialmedia">
                <a
                  href="https://www.linkedin.com/in/anandumon-un-349671204"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
                ...
                <a
                  href="https://github.com/anandumon"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
                ...
                <a
                  href="https://www.instagram.com/anandumon/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
                ...
                <a
                  href="mailto:anandumonun@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
